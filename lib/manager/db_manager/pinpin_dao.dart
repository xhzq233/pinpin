...
class PinPinDao {
  ...
  static Future<void> updatePinPin(int pinpinId, PinPin pinpin) async {
  ...
  static Future<void> deletePinPin(int pinpinId, bool isDeleted) async {
    await ppDB.rawUpdate("UPDATE $pinpinTableName SET is_delete = ? where pinpin_id = ?",
        [isDeleted, pinpinId]);
  }

  static Future<void> followPinPin(int pinpinId, bool isFollowed) async {
