...
const initHttp = _PPNetworkImplement.init;

class _PPNetworkImplement extends HttpClientInterface with PPNetWorkInterface {
  _PPNetworkImplement.init(
      {required super.deviceName, required super.accountGetter, required super.accountUpdater, required super.toaster})
      : super.init();
  ...
  Future<MsgResponse?> followPinPin({
    ...
    return requestForMsg(Api.followPinPin, MsgResponse.fromJson, data: {
      "PinpinId": pinPinId,
    });
  }
