...
void main() {
  ...
  var http = initPPHttp(accountGetter: () {}, deviceName: '', accountUpdater: (account) {});
  group("API", () {
    /// welcome
    ...
    test("createUser", () async {
      MsgResponse? msg;
      msg = await http.createUser(
          email: "U202013777",
          username: "www",
          password: "5156",
          img:
              "https://www.google.com/imgres?imgurl=https%3A%2F%2Fpic.baike.soso.com%2Fugc%2Fbaikepic2%2F4835%2F20220301104313-1985040554_png_860_1409_202178.jpg%2F0&imgrefurl=https%3A%2F%2Fbaike.sogou.com%2Fv30052.htm%3Fpid%3Dbaike.box&tbnid=39STO30sfJdMVM&vet=12ahUKEwi_04rR2p35AhWMgGMGHRfFBTUQMygBegUIARC0AQ..i&docid=GOTZqHXHXTbovM&w=860&h=1409&q=%E6%B4%BE%E5%A4%A7%E6%98%9F&ved=2ahUKEwi_04rR2p35AhWMgGMGHRfFBTUQMygBegUIARC0AQ");
      //参数为空出现400
      print(msg);
    });
    test("SignIn", () async {
